...
contract Auction {
    ...
    function Auction() public payable{ //constructor
        ...
        items[0] = Item({itemId:0,itemTokens:emptyArray}); //Part 1 Task 2. Initialize two items with at index 1 and 2.
   ...
   function register(address bidder) public payable{
    ...
    function bid(uint _itemId, uint _count) public payable{
        ...
        /*
        Bids tokens to a particular item. Arguments:
        ...
        */
        if(tokenDetails[msg.sender].remainingTokens < 2) return;
        // ** Start code here. 2 lines approximately. **/
        //** End code here. **
